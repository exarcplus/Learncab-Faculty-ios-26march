...
const CGFloat kDIDatepickerSpaceBetweenItems = 1.;
...
- (UICollectionView *)datesCollectionView
{
    if (!_datesCollectionView) {
        ...
        _datesCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0,0, [UIScreen mainScreen].bounds.size.width, self.bounds.size.height) collectionViewLayout:collectionViewLayout];
        [_datesCollectionView registerClass:[DIDatepickerCell class] forCellWithReuseIdentifier:kDIDatepickerCellIndentifier];
        [_datesCollectionView setBackgroundColor:[UIColor colorWithRed:0.867 green:0.867 blue:0.867 alpha:1.00]];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_selectedDate == [self.dates objectAtIndex:indexPath.item])
    {
        cell.selectionView.alpha = 1.0;
    }
    else
    {
